...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            if newSentence.cells.issubset(sentence.cells) and count> 0 and newSentence.count> 0 and newSentence!=sentence:
                newSubset=sentence.cells.difference(newSentence.cells)
                newSentenceSubset=Sentence(list(newSubset),newSentence.count)
    ...
    def make_safe_move(self):
        ...
        for cell in self.safes:
            if cell not in self.moves_made: #not same
                return cell
